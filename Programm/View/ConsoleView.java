...
public class ConsoleView implements View {
    ...
    private final Controller kennelAccounting;
    private Scanner scanner;

    public ConsoleView(Controller kennelAccounting) {
        this.kennelAccounting = kennelAccounting;
        scanner = new Scanner(System.in);
    }

    record AnimalData(String name, LocalDate birthDate, AnimalKind animalGenius){}
    ...
    public boolean showAddAnimalDialog() {
        String infoMessage = "Введите параметры животного в виде строки: \"имя день_рождения род_животного\"\n" +
                ...
                "род_животного может принимать значения: " + Arrays.asList(AnimalKind.values());
...
//            }
    ...
    public void showDetailInfoAnimalDialog() {
        ...
        while (true) {
            try {
                ...
                Animal animal = kennelAccounting.getAnimals().get(animalNumber - 1);
    ...
    @Override
    public AddSkillMenuCommand showAddSkillMenu(Animal animal) {
        String menu = String.format(
                "%d-[%s]\t%d-[%s]\n",
    ...
    @Override
    public boolean showAddSkillDialog(Animal animal) {
    ...
    private AnimalData parceAnimalData(String inputData) {
        ...
        AnimalKind genius = AnimalKind.valueOf(input[2].toUpperCase());
