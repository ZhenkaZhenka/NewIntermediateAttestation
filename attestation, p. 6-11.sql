-- Подключенном MySQL репозитории создать базу данных “Друзья человека”
...
INSERT INTO Pets (name, birthDate, genius_id)
VALUES
 ('Гнедой', '2021-02-04', 1),
...
USE HumanFriends;
   DELETE FROM Pets WHERE genius_id = 2;

   CREATE TABLE HorseAndDonkey AS
   SELECT * from Pets WHERE genius_id = 1
   UNION
   SELECT * from Pets WHERE genius_id = 3;
   
-- Создать новую таблицу “молодые животные” в которую попадут все животные старше 1 года, но младше 3 лет и в отдельном столбце с 
